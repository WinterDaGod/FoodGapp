...
class AuthResult {
  ...
  const AuthResult._({this.user, this.errorMessage, this.success = false});

  factory AuthResult.success(User? user) => AuthResult._(user: user, success: true);
...
class AuthService {
  ...
  Future<AuthResult> sendPasswordResetEmail(String email) async {
    try {
      ...
      return AuthResult.failure('Could not send reset email. Please try again.');
    }
  }
