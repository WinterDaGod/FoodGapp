...
class DostFnriGuidelines {
  ...
  // --- Balanced Mid-points (AMDR 2015) --------------------------------------
  
  /// Carbohydrates mid-point: 65% of total energy.
  static const carbohydrateMidPercent = 65.0;

  /// Protein mid-point: 12.5% of total energy.
  static const proteinMidPercent = 12.5;

  /// Total fat mid-point: 22.5% of total energy.
  static const fatMidPercent = 22.5;
